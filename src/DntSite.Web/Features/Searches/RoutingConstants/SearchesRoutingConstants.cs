...
public static class SearchesRoutingConstants
{
    ...
    public const string SearchedItemsDeleteBase = $"{SearchedItems}/delete";

    public const string SearchedItemsDeleteDeleteId =
        $"{SearchedItemsDeleteBase}/{{DeleteId:{EncryptedRouteConstraint.Name}}}";
