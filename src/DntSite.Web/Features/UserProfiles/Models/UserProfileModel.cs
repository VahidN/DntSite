...
public class UserProfileModel
{
    ...
    [StringLength(1000, ErrorMessage = "حداکثر طول آدرس هاست 1000 حرف است.")]
    [DataType(DataType.Url)]
    public string? HomePageUrl { set; get; }

    public string? Photo { set; get; }

    [UploadFileExtensions(".jpg,.gif,.png,.jpeg", ErrorMessage = "لطفا فقط فایل تصویری ارسال کنید.")]
    [AllowUploadOnlyImageFiles(150, 150, ErrorMessage = "لطفا یک فایل تصویری معتبر 150 در 150 پیکسل را ارسال کنید")]
    [Display(Name = "تصویر جدید")]
    public IFormFileCollection? PhotoFiles { set; get; }

    [Display(Name = "درباره من")]
    [StringLength(2000, ErrorMessage = "حداکثر طول توضیحات شخصی 2000 حرف است.")]
