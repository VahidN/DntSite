...
public class ProjectFaqCommentConfig : IEntityTypeConfiguration<ProjectFaqComment>
{
    public void Configure(EntityTypeBuilder<ProjectFaqComment> builder)
    {
        ...
        builder.HasOne(entity => entity.User)
            .WithMany(user => user.ProjectFaqComments)
