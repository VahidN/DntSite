...
public class ProjectIssueCommentConfig : IEntityTypeConfiguration<ProjectIssueComment>
{
    public void Configure(EntityTypeBuilder<ProjectIssueComment> builder)
    {
        ...
        builder.HasOne(entity => entity.User)
            .WithMany(user => user.ProjectIssueComments)
